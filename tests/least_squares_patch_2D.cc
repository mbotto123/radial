...
void least_squares_patch_integral_test_P1_2D()
{
  const int dim = 2;
  const int order = 1;
...
void least_squares_patch_integral_test_P2_2D()
{
  const int dim = 2;
  const int order = 2;
...
int main()
{
  ...
  least_squares_patch_integral_test_P1_2D();
  least_squares_patch_integral_test_P2_2D();
