...
void ppr_discrete_interpolant_test_P1_2D()
{
  const int dim = 2;
  const int order = 1;
  ...
  //-------------------------------------------------------------------------//
  // Solution recovery
  radial::recover_solution_ppr_discrete(dof_handler, mapping, interpolant,
...
void ppr_integral_interpolant_test_P1_2D()
{
  const int dim = 2;
  const int order = 1;
...
void ppr_discrete_interpolant_test_P2_2D()
{
  const int dim = 2;
  const int order = 2;
...
void ppr_integral_interpolant_test_P2_2D()
{
  const int dim = 2;
  const int order = 2;
...
int main()
{
  ppr_discrete_interpolant_test_P1_2D();
  ppr_discrete_interpolant_test_P2_2D();

  ppr_integral_interpolant_test_P1_2D();
  ppr_integral_interpolant_test_P2_2D();
